...
#   storage-service        output binary name
#   19093        grpcx gRPC listen port
#   18083          optional grpc-gateway listen port
...
WORKDIR /app
COPY --from=builder /out/storage-service /app/storage-service
